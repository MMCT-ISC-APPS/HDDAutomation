...
{
    public partial class Rpt_InkPrintTrackingDetail : Form
    {
        ...
        public Rpt_InkPrintTrackingDetail(string Code_No)
        {
            InitializeComponent();
            txtPanel.Text = Code_No;
        ...
        public Rpt_InkPrintTrackingDetail(MDIParent1 containerForm)
        {
        ...
        private DataTable Getdata(string Serial)
        {
            ...
            sql.Append("	  ,[SERIALNO]	");
            sql.Append("	      ,JOBNAME_PUNCH as JOBNAME	");
            ...
            sql.Append("	   AND (GenCode_ID = '" + Serial + "' OR  PrintCode_ID = '" + Serial + "')	");
